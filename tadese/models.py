...
class Tributo(models.Model):
    ...
    sinpunit_fecha_desde = models.IntegerField(db_column='SINPUNIT_FECHA_DESDE', blank=True, null=True)
...
class Cuotas(models.Model):
    ...
    tributo = models.ForeignKey('Tributo', db_column='tributo',related_name='cta_tributo',on_delete=models.CASCADE)
...
class DriBoleta(models.Model):
    ...
    id_cuota = models.ForeignKey('Cuotas', db_column='id_cuota',related_name='boleta_cuota',on_delete=models.SET_NULL,blank=True, null=True)
...
class Suscriptores(models.Model):
    ...
    tributo = models.ForeignKey('Tributo', db_column='tributo',related_name='suscr_tributo',on_delete=models.SET_NULL,blank=True, null=True)        
