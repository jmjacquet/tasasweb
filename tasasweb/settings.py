...
LOGIN_URL = '/login/'
LOGIN_REDIRECT_URL='/'
AUTHENTICATION_BACKENDS = ['tadese.authentication.ContribuyentesBackend','tadese.authentication.EstudiosBackend','tadese.authentication.idCuotaBackend','django.contrib.auth.backends.ModelBackend']
